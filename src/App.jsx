...
function App() {
  ...
  return (
    <>
        ...
        <Element name="hero" className="hero  min-h-screen backdrop-blur-sm ">
          ...
          <div className="hero-content text-center text-neutral-content ">
            <div className="max-w-md">
              <p className="text-6xl bebas bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent  ">I'M JAILER </p>
              <div className="avatar my-7  group">
                <div className="w-24 mask mask-hexagon relative">
                  <img src={logo1}  className=""/>
                 
                </div>
                <a className="rounded-full absolute -bottom-5 left-7 w-10 h-10 bg-[#1d232a] p-2  "><PiHandWavingDuotone className="w-full h-full text-yellow-500 wave"/></a>
              </div>
      ...
      {/*Hero*/}
      <Element name="aboutme" className="flex justify-center w-full h-screen">
        <div className="hero">
          <div className="hero-content w-full flex-col lg:flex-row-reverse">
            <img
              src={foto}
              className="max-w-xs rounded-full shadow-2xl p-6"
            />
            <div>
              <h1 className="text-5xl font-bold text-shadow text-white sm:text-center">HI! I'M JAILER</h1>
      ...
      >
        ...
        Since 2020 studying on my own and numerous courses to always be prepared
        </span>
